...
For installation and using a trained checkpoint for inference, see [`README.md`](README.md).
This covers training your own model and reproducing the Interspeech 2026 paper's results from
scratch.
...
synthesizing speech via the frozen SPARC vocoder, and computing all reported metrics
(DTW/Pearson correlation against SPARC-extracted ground truth, DNSMOS, WER, SECS, human NMOS).
Set the data/output paths in the first few cells before running.
